...
$p=1/(1+exp(E[y]))$ in that :  $E[y]$ = $\beta_0$ + $\beta_1x_1$ + $\beta_2x_2$ +...+$\beta_kx_k$ + $\epsilon$

+ p is the logit probability to predict the model.
